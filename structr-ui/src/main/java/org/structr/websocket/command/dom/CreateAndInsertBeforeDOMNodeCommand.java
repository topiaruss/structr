 ...
 */
public class CreateAndInsertBeforeDOMNodeCommand extends AbstractCommand {

	static {
		
		StructrWebSocket.addCommand(CreateAndInsertBeforeDOMNodeCommand.class);
	}
	...
	public String getCommand() {
		return "CREATE_AND_INSERT_BEFORE_DOM_NODE";
	}
